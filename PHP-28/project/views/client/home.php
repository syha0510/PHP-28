            ...
            <?php foreach ($threePost as $key => $value): ?>
              <div class="post featured-post-xl">
                  <div class="details clearfix">
                      <a href="category.html" class="category-badge lg"><?= $value['name'] ?></a>
                      <h4 class="post-title"><a href="?admin=admin&mod=post&act=detailpost&id=<?= $value['id'] ?>"><?= $value['title'] ?></a></h4>
                  ...
                  <a href="?admin=admin&mod=post&act=detailpost&id=<?= $value['id'] ?>">
                      <div class="thumb rounded">
                          <div class="inner data-bg-image" data-bg-image="publics/images/<?= $value['thumbnail'] ?>"></div>
                      </div>
                  </a>
              </div>
            <?php endforeach; ?>
      ...
      <?php foreach ($get6Post as $key => $value): ?>
        <div class="post post-classic rounded bordered">
          <div class="thumb top-rounded">
            <a href="" class="category-badge lg position-absolute"><?= $value['name'] ?></a>
