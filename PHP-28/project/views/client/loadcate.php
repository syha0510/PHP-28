  ...
  <section class="page-header">
      <div class="container-xl">
          <div class="text-center">
              <h1 class="mt-0 mb-2"><?= $getCategoryname['name']  ?></h1>
              <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center mb-0">
                      <li class="breadcrumb-item"><a href="index.php">Trang chủ</a></li>
                      <li class="breadcrumb-item active" aria-current="page"><?= $getCategoryname['name']  ?></li>
                  </ol>
              </nav>
          </div>
      </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="post post-grid rounded bordered">
                                <div class="thumb top-rounded">
                                    <a href="category.html" class="category-badge position-absolute"><?= $value['name'] ?></a>
                                    <a href="?admin=admin&mod=post&act=detailpost&id=<?= $value['id'] ?>">
                                        <div class="inner">
                                            <img style="height:200px;width:100%;" src="publics/images/<?= $value['thumbnail'] ?>" alt="post-title">
                                        </div>
                                    </a>
                                </div>
                                <div class="details">
                                    ...
                                    <h5 class="post-title mb-3 mt-3"><a href="?admin=admin&mod=post&act=detailpost&id=<?= $value['id'] ?>"><?= $value['title']  ?></a></h5>
                                    <!-- <h6 class="post-title mb-3 mt-3"><a href="?admin=admin&mod=post&act=detailpost&id=<?= $value['id'] ?>"><?= $value['content']  ?></a></h6> -->
                                </div>
